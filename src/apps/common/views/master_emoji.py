...
KINO_ID_BASE = "master-emojis"

class M_EmojiViewSet(CommonResponseMixin, viewsets.ModelViewSet):
    """
    絵文字マスタ CRUD ViewSet
    """
    serializer_class = MasterEmojiMiniResponseSerializer
    ...
    def perform_destroy(self, instance: M_Emoji):
        """物理削除を論理削除に書き換える"""
