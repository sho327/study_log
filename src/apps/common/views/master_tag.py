...
# --- 共通モジュール ---
from apps.common.models import M_Tag
from apps.common.serializers.master_tag_base import MasterTagMiniResponseSerializer

KINO_ID_BASE = "master-tags"

class M_TagViewSet(CommonResponseMixin, viewsets.ModelViewSet):
    """
    タグマスタ CRUD ViewSet
    """
    serializer_class = MasterTagMiniResponseSerializer
    ...
    def perform_destroy(self, instance: M_Tag):
        """物理削除を論理削除に書き換える"""
