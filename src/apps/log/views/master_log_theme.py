...
class M_LogThemeViewSet(CommonResponseMixin, viewsets.ModelViewSet):
    ...
    """
    serializer_class = MasterLogThemeMiniResponseSerializer
    ...
    def get_queryset(self):
        ...
        return M_LogTheme.objects.filter(
    ...
    def perform_destroy(self, instance: M_LogTheme):
        """物理削除を論理削除に書き換える"""
    ...
    # ------------------------------------------------------------------
    # 更新 (PUT/PATCH /master_log_themes/{id}/)
    # ------------------------------------------------------------------
    @logging_process_with_sql
    ...
    # ------------------------------------------------------------------
    # 削除 (DELETE /master_log_themes/{id}/)
    # ------------------------------------------------------------------
    @logging_process_with_sql
